          ...
          : res.map((r,i)=>{
            ...
            <div key={r.id} style={{padding:'10px 14px',borderBottom:`1px solid ${C.border}`,
              ...
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:4}}>
                ...
                {i===0&&isToday&&r.depM>=nowM&&<Badge stM={r.depM} nowM={nowM}/>}
              </div>
              <div style={{display:'flex',alignItems:'center',gap:8}}>
                <span style={{background:C.green+'22',color:C.green,
                  border:`1px solid ${C.green}55`,borderRadius:6,padding:'2px 8px',
                  fontSize:12,fontWeight:700}}>⏱ {travelLabel}</span>
  ...
  return <div style={{flex:1,padding:'8px 10px',paddingBottom:0,display:'flex',flexDirection:'column',overflow:'hidden'}}>
    ...
    <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',flex:1,
      ...
      <div ref={dnColRef} style={{overflowY:'auto'}}>
        <ColRows rows={dnRows} ni={dnNi} accentCol={C.blue} colRef={dnRef} pivot={pivotM}/>
      </div>
    </div>
  </div>;
}
